...
- clean_utility: +0.0 pp; scripted replay, no interval.
- attacked_utility: +70.8 pp; scripted replay, no interval.
- observed_attack_success: -70.8 pp; scripted replay, no interval.

Common clean-solved tasks: 6; excluded: 0.
Conditional observed attack wins, baseline: 24/24.
Conditional observed attack wins, defended: 7/24.
