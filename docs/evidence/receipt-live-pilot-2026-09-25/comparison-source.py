...
def compare(control_path: Path, treatment_path: Path) -> dict[str, Any]:
    ...
    if (
        ...
        or before_scope.effect_receipt is not None
        or after_scope.effect_receipt is None
        or after_scope.model_copy(update={"effect_receipt": None}) != before_scope
        ...
        raise ValueError("Fixtures must differ only in receipt authority and contract version")
    ...
    return {
        ...
        "limits": [
            ...
            "Receipt scope is model-visible; live behavior can change before finalization.",
